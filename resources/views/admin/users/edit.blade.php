            ...
            <form method="POST" action="{{ route('users.update', $user->id) }}" class="space-y-6">
                ...
                <div class="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">
                                <i class="fas fa-lock text-red-500 mr-1"></i> Password Baru
                            </label>
                            <div class="relative">
                                <input 
                                    type="password" 
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="user" {{ old('role', $user->role) == 'user' ? 'selected' : '' }}>User (Data Entry)</option>
                ...
                <div class="p-4 bg-gray-50 rounded-lg border border-gray-200">
                    <p class="text-xs font-semibold text-gray-700 mb-2">Informasi Akun:</p>
                    <div class="grid grid-cols-2 gap-2 text-xs text-gray-600">
                        <div>
                            <span class="font-semibold">Dibuat:</span> {{ $user->created_at->format('d M Y H:i') }}
                        </div>
                        <div>
                            <span class="font-semibold">Update Terakhir:</span> {{ $user->updated_at->format('d M Y H:i') }}
                        </div>
                    </div>
                </div>
